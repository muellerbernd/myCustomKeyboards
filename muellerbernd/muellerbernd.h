...
#define I3_L LGUI(LSFT(KC_LEFT))
#define I3_R LGUI(LSFT(KC_RIGHT))
...
#define COLDH_L3 DE_Z, DE_X, DE_T, DE_D, DE_V
...
#define LOWER_L1 KC_F9, KC_F10, KC_F11, KC_F12, XXXXXXX
#define LOWER_L2 KC_F5, KC_F6, KC_F7, KC_F8, XXXXXXX
#define LOWER_L3 KC_F1, KC_F2, KC_F3, KC_F4, XXXXXXX
...
#define NAV_L1 KC_ESC, KC_BTN1, KC_MS_U, KC_BTN2, KC_WH_U
#define NAV_L2 KC_TAB, KC_MS_L, KC_MS_D, KC_MS_R, KC_WH_D
#define NAV_L3 STAB, _______, _______, _______, _______
#define NAV_R1 TABD, KC_PGUP, KC_UP, KC_PGDN, TABU
#define NAV_R2 KC_HOME, KC_LEFT, KC_DOWN, KC_RIGHT, KC_END
#define NAV_R3 _______, _______, _______, _______, _______

#define ADJUST_L1 RGB_TOG, RGB_MOD, RGB_HUI, RGB_SAI, RGB_VAI
#define ADJUST_L2 XXXXXXX, XXXXXXX, RGB_HUD, RGB_SAD, RGB_VAD
...
#define ADJUST_R3 QWERTZ , COLDH  , _______, _______, XXXXXXX
